export default function Footer () {
  return(
    <>
      ...
      <footer class="flex flex-wrap justify-center lg:justify-between overflow-hidden gap-10 md:gap-20 py-16 px-6 md:px-16 lg:px-24 xl:px-32 text-[13px] text-gray-500 bg-gradient-to-r from-white via-indigo-200/60 to-white mt-32">
        <div class="flex flex-wrap items-start gap-10 md:gap-[60px] xl:gap-[140px]">
            <a href="https://prebuiltui.com">
                <img src="/logo.svg" alt="logo" class="h-11 w-auto" />
            </a>
            <div>
