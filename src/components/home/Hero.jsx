            ...
            <div className="min-h-screen pb-10">
                ...
                <div className="relative flex flex-col items-center justify-center text-sm px-4 md:px-16 lg:px-24 xl:px-40 text-black">
                    ...
                    <h1 className="text-5xl md:text-6xl font-semibold max-w-5xl text-center mt-4 md:leading-[70px]">
                        Get Your Dream job with <span className=" bg-gradient-to-r from-indigo-700 to-indigo-600 bg-clip-text text-transparent text-nowrap">Ai-Powered </span> Resumes.
                    </h1>

                    <p className="max-w-md text-center text-base my-7">Create, Edit and download professional resumes with Ai-powered assistence.</p>
